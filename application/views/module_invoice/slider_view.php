						...
						<div class="row">
							<div class="col-md-4" id="f_panel">
								<div class="card m-t-10">
									...
									<div class="card-body">
										<?php echo $error; ?>
										<form enctype="multipart/form-data" class="row  needs-validation" novalidate method="POST" action="<?php echo base_url() ?>Invoice/insert_slider_data">
