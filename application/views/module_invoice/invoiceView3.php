...
<body>
    <div id="page-1" class="pagedjs_page">
        <div class="pagedjs_pagebox">
            <div class="pagedjs_margin pagedjs_margin-top-left hasContent">
            ...
            <div class="pagedjs_margin pagedjs_margin-top-right hasContent">
                <div class="pagedjs_margin-content">
                            ...
                            <table class="table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Net Amount</td>
                                        <?php if ($sheet_type == 1) { ?>
                                            <td><?php echo "PKR " . number_format(($total_sc + $total_osa_sd + $total_gst + $total_fuel + $other_amount + $t_fuel + $t_others + $t_osa + $t_faf) - $discounSSt_amount); ?></td>
                                        <?php } else { ?>
                                            <td><?php echo "PKR " . number_format(($total_sc + $total_osa_sd + $total_fuel + $other_amount + $t_fuel + $t_others + $t_osa + $t_faf) - $discounSSt_amount); ?></td>
                                        <?php } ?>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($sheet_type == 1) { ?>
                                            <td>
                                                <?php
                                                $total_net = round(($total_sc + $total_osa_sd + $total_gst + $total_fuel + $t_fuel + $t_others + $t_osa + $other_amount + $t_faf) - $discounSSt_amount);
                                        ...
                                        <?php } else { ?>
                                            <td>
                                                <?php
                                                $total_net = round(($total_sc + $total_osa_sd + $total_fuel + $t_fuel + $t_others + $t_osa + $other_amount + $t_faf) - $discounSSt_amount);
                                                $get_amount = AmountInWords($total_net);
                                                echo "Rs. " . $get_amount . " only";
                                                ?>
                                            </td>
    ...
    <div id="page-2" class="pagedjs_page">
        <div class="pagedjs_pagebox">
    ...
    <!--<table id="footer">
        ...
        <tr>
            <td class="text-left">It is a system-generated invoice and doesn't need any signature or stamp.</td>
